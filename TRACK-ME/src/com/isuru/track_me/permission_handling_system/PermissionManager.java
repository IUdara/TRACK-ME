...
public class PermissionManager extends Service {
		...
		if (intent.getStringExtra("message") != null) {
			...
			if (message.startsWith("Track:")) {
				...
				if (message != null && message.length() == 5) {
					...
					// this.checkTrackingPermission(message,
					// phoneNo);
					if (isPermitted) {
	...
	public Permission extractPermission(String message, String sender) {
	...
	public void launchNotification(String message) {
